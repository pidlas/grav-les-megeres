...
# On stocke la route interne propre calculée dynamiquement par Grav
route_parent: '{{ page.route() }}'
---
<div class="encadre">

<div class="gresilhette-et-la-salimonde">
<h2 class="coco">Spectacle jeune public dès 6 ans - 40 mn</h2>

<div class="wrapper-video">
<video id="video" controls preload="auto" loading="metadata" width="640" height="360">
<source src="{{ page.media['teaser-gresilhette-salimonde.mp4'].url() }}" type="video/mp4" />
<source src="{{ page.media['teaser-gresilhette-salimonde.webm'].url() }}" type="video/webm" />
...
<span id="time" class="time-display">0:00 / 0:00</span>

<div class="volume-control-zone">
...
<button id="fullscreenBtn" class="control-btn" aria-label="Plein écran">
...
<svg class="exit-fs-icon" viewBox="0 0 24 24"><path d="M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z"/></svg>
</button>
</div>
</div>
...
[a class="g_sp_theatre-d-ombres morph" url="{{ page.route() }}/theatre-d-ombres"]
[img name="sp_theatre-d-ombres.avif" alt="Spectacle Grésilhette et la Salimonde - Théâtre d'ombres" /]
[/a]
[a class="g_sp_sieste-contee morph" url="{{ page.route() }}/sieste-contee"]
[img name="sp_sieste-contee.avif" alt="La sieste contée - Grésilhette et la Salimonde" /]
[/a]
[a class="g_sp_projet-pedagogique morph" url="{{ page.route() }}/projet-pedagogique"]
...
<p class="g_sp_e-presentation">[a url="dossier-prez_compressed.pdf" title="Visualiser le dossier artistique Grésilhette et la Salimonde de la compagnie Les Mégères de l'Humus"]
...
<span>Accompagnement : Anne Spielman</span><br></p>
</div>
</div>
</div>

<div class="encadre-lenga">

<div class="la-lenga-occitana">
<h2 class="display-title">La langue occitane dans le spectacle</h2>
